...
public class Part1Client1 extends AMultiLayerCounterClient {
	...
	/**
	 * Code for making explicit receive calls to receive messages It does not
	 * work in the default implementation. Your assignment should make it work.
	 */
	 ...
	 * 
	 * Use the main thread to receive and print messages explicitly. USe this to
	 * test your implementation of receive.
	 * 
	 */
